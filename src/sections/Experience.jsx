...
const experiences = [
  {
    role: "Web Developer",
    Campus: "Saylani Mass IT Training",
    duration: "2025 - Present",
    description:
      "Worked to build high-performance apps, integrated AI features, and improved engagement by 10%.🚀",
  },
  
  {
    ...
    duration: "2022 - 2023",
    description:
      "Completed a Shopify course and learned to build and manage e-commerce stores. Experienced in store setup, product listing, and basic theme customization.👍",
  },
{
    role: "Video Editor",
    company: "Freelance",
    duration: "2023 - 2024",
    description:
      "Skilled in video editing, creating engaging and polished content. Experienced with trimming, effects, and smooth transitions. ✅",
  },
