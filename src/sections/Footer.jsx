 ...
 */
const socials = [
  { Icon: FaYoutube, label: "YouTube", href: "https://www.youtube.com/@kinzariaz-y8l" },
  // { Icon: FaXTwitter, label: "X", href: "https://x.com/kinzariaz" },
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/kinza-riaz-078bb135a/" },
  { Icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/kinzariaz025/" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/Kinzariaz" },
];
    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} Kinza Riaz. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
