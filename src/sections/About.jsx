        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
             I build responsive and user-friendly web applications using HTML, CSS, Bootstrap, JavaScript, React.js, and the MERN stack — turning ideas into modern, scalable, and functional digital experiences.
            </p>
        ...
        <div className="grid md:grid-cols-1">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
             I’m a Software Developer, Content Creator, and Web Developer — passionate about building fast, resilient applications and sharing coding insights on LinkedIn and Github.
            </p>
